...
def render() -> None:
	...
	EXECUTION_QUEUE_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(fa.choices.execution_queue_count_range),
		minimum = fa.choices.execution_queue_count_range[0],
		maximum = fa.choices.execution_queue_count_range[-1]
	)
