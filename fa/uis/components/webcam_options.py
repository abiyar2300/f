...
import fa.choices
from fa import wording
from fa.common_helper import get_first
from fa.uis.components.webcam import get_available_webcam_ids
...
def render() -> None:
	...
	WEBCAM_MODE_RADIO = gradio.Radio(
		...
		choices = fa.choices.webcam_modes,
		value = 'inline'
	)
	WEBCAM_RESOLUTION_DROPDOWN = gradio.Dropdown(
		label = wording.get('uis.webcam_resolution_dropdown'),
		choices = fa.choices.webcam_resolutions,
		value = fa.choices.webcam_resolutions[0]
	)
