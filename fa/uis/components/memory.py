...
from fa.types import VideoMemoryStrategy
...
def render() -> None:
	...
	VIDEO_MEMORY_STRATEGY_DROPDOWN = gradio.Dropdown(
		...
		choices = fa.choices.video_memory_strategies,
	...
	SYSTEM_MEMORY_LIMIT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(fa.choices.system_memory_limit_range),
		minimum = fa.choices.system_memory_limit_range[0],
		maximum = fa.choices.system_memory_limit_range[-1],
