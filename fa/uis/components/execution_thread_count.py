...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calc_int_step(fa.choices.execution_thread_count_range),
		minimum = fa.choices.execution_thread_count_range[0],
		maximum = fa.choices.execution_thread_count_range[-1]
	)
