...
import fa.choices
import fa.jobs.job_manager
import fa.jobs.job_store
import fa.processors.core as processors
from fa import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, inference_manager, logger, process_manager, state_manager, wording
from fa.common_helper import get_first
from fa.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from fa.execution import has_execution_provider
from fa.face_analyser import get_average_face, get_many_faces, get_one_face
from fa.face_helper import paste_back, warp_face_by_face_landmark_5
from fa.face_masker import create_occlusion_mask, create_region_mask, create_static_box_mask
from fa.face_selector import find_similar_faces, sort_and_filter_faces, sort_faces_by_order
from fa.face_store import get_reference_faces
from fa.filesystem import filter_image_paths, has_image, in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from fa.model_helper import get_static_model_initializer
from fa.processors import choices as processors_choices
from fa.processors.pixel_boost import explode_pixel_boost, implode_pixel_boost
from fa.processors.types import FaceSwapperInputs
from fa.program_helper import find_argument_group
from fa.thread_helper import conditional_thread_semaphore
from fa.types import ApplyStateItem, Args, DownloadScope, Embedding, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from fa.vision import read_image, read_static_image, read_static_images, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		fa.jobs.job_store.register_step_keys([ 'face_swapper_model', 'face_swapper_pixel_boost' ])
...
def forward_swap_face(source_face : Face, crop_vision_frame : VisionFrame) -> VisionFrame:
	...
	if has_execution_provider('coreml') and model_type in [ 'ghost', 'uniface' ]:
		face_swapper.set_providers([ fa.choices.execution_provider_set.get('cpu') ])
