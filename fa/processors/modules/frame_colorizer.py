...
from fa import config, content_analyser, inference_manager, logger, process_manager, state_manager, wording
...
from fa.processors.types import FrameColorizerInputs
from fa.program_helper import find_argument_group
from fa.thread_helper import thread_semaphore
from fa.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from fa.vision import read_image, read_static_image, unpack_resolution, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		fa.jobs.job_store.register_step_keys([ 'frame_colorizer_model', 'frame_colorizer_blend', 'frame_colorizer_size' ])
