...
from fa.common_helper import create_int_metavar
from fa.download import conditional_download_hashes, conditional_download_sources, resolve_download_url
from fa.face_analyser import get_many_faces, get_one_face
from fa.face_helper import paste_back, warp_face_by_face_landmark_5
from fa.face_masker import create_occlusion_mask, create_static_box_mask
from fa.face_selector import find_similar_faces, sort_and_filter_faces
from fa.face_store import get_reference_faces
from fa.filesystem import in_directory, is_image, is_video, resolve_relative_path, same_file_extension
from fa.processors import choices as processors_choices
from fa.processors.live_portrait import create_rotation, limit_expression
from fa.processors.types import ExpressionRestorerInputs, LivePortraitExpression, LivePortraitFeatureVolume, LivePortraitMotionPoints, LivePortraitPitch, LivePortraitRoll, LivePortraitScale, LivePortraitTranslation, LivePortraitYaw
from fa.program_helper import find_argument_group
from fa.thread_helper import conditional_thread_semaphore, thread_semaphore
from fa.types import ApplyStateItem, Args, DownloadScope, Face, InferencePool, ModelOptions, ModelSet, ProcessMode, QueuePayload, UpdateProgress, VisionFrame
from fa.vision import read_image, read_static_image, read_video_frame, write_image
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		fa.jobs.job_store.register_step_keys([ 'expression_restorer_model', 'expression_restorer_factor' ])
